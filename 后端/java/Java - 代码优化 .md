...
调用过程如下图所示：![图片](E:\Development\Typora\images\640.png)调用远程接口总耗时 530ms = 200ms + 150ms + 180ms
...
如下图所示：![图片](E:\Development\Typora\images\640-16622848746541.png)调用远程接口总耗时 200ms = 200ms（即耗时最长的那次远程接口调用)
...
1. spring的`@Lazy`注解。在spring容器启动的时候，不会调用其getBean方法初始化实例。
...
如果不做任何处理，当我们请求add接口时，执行结果直接报错：![图片](E:\Development\Typora\images\640-16622848746542.png)what？用户能直接看到错误信息？
...
先看看Integer的构造方法：![图片](E:\Development\Typora\images\640-16622848746543.jpeg)
...
![图片](E:\Development\Typora\images\640-16622848746544.jpeg)
...
下面用一张图看看大事务引发的问题。![图片](E:\Development\Typora\images\640-16622848746545.png)从图中能够看出，大事务问题可能会造成接口超时，对接口的性能有直接的影响。
...
![图片](E:\Development\Typora\images\640-16622848746556.jpeg)
