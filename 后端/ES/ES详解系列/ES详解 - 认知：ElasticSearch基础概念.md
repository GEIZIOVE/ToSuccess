...
![img](E:/Development/Typora/images/es-introduce-1-2-1675322203453-1.png)
...
> ElasticSearch是一款非常强大的、**基于Lucene**的开源搜索及分析引擎；它是一个实时的分布式搜索分析引擎，它能让你以前所未有的速度和规模，去探索你的数据。
...
![img](E:/Development/Typora/images/es-introduce-1-3-1675323803902-4.png)
...
著作权归@pdai所有 原文链接：https://pdai.tech/md/db/nosql-es/elasticsearch-x-introduce-1.html